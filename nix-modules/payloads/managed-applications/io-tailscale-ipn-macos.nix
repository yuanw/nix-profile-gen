...
in
{
  options.programs.macprofile.payloads."managed-applications-io-tailscale-ipn-macos" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "Tailscale (MAS) (io.tailscale.ipn.macos) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}